/**
 * A simple server that serves static files and forces authentication while using cookies
 *
 ...
 * the static files and will set a cookie after initial authentication.
 */
...
app.use(morgan('dev'));
// Set up the cookieParser with a secret key
